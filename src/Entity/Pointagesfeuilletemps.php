...
/**
 * Pointagesfeuilletemps
 *
 * @ORM\Table(name="pointagesFeuilleTemps")
 * @ORM\Entity(repositoryClass="App\Repository\FeuilleDeTempsRepository")
 */
class Pointagesfeuilletemps
{
    /**
     * @var int
     *
